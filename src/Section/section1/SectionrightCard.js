...
function SectionrightCard(props) {
    ...
    return (
        <div className="pov-card" style={{minHeight:"0rem", marginTop:"2rem", paddingTop:"1rem",position:"relative", display:"inline-block" }}>
            <h4 style={{ fontSize: "15px", marginLeft: "6px",marginRight: "8px", display: "inline-block", fontWeight:"600" }}>Pov <div style={{ background: "red", display: "inline-block", width: "8.8rem", height: "3.5px", marginBottom:"3px", marginLeft:"10px" }}></div></h4>
           { props.data?(
            <div className="row">
             
                <div className="pov-card-right-col-md-12">
                    <div className='top-card' style={{ width: "20rem",marginLeft:"11px" }}>
                        <img src={props.data[0].image_url} className='img-fluid' style={{minWidth:"9rem"}} alt="" />
                ...
                <h4 style={{ fontSize: ".9rem", marginLeft: "6px", display: "inline-block" }}>Reader Editors<div style={{ background: "red", display: "inline-block", width: "2.5rem", height: "3.5px",marginLeft:"10px", marginBottom:"3px"}}></div></h4>
                            <div style={{width:"19rem",marginLeft:"15px"}}>
                            
                               <p style={{fontSize:".7rem",fontWeight:500,marginLeft:"-7px", width:"10em"}}>
